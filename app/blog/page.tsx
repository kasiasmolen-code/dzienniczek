...
export default function BlogPage() {
  ...
  return (
    <div className="lg:flex lg:h-screen lg:overflow-hidden bg-background">
      {/* Boczna nawigacja (desktop) — nie znika na blogu, Blog jest podświetlony */}
      <div className="hidden lg:block h-full">
        <DesktopSidebar />
      </div>

      <main className="flex-1 lg:overflow-y-auto px-4 pt-10 pb-28 lg:pb-10 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-4">
              {articles.map(a => (
                ...
                >
                  {a.coverUrl && (
                    <img src={a.coverUrl} alt={a.title} className="w-full h-44 object-cover" />
                  )}
